...
springのjarfileでクラスパスに関連するjarを通す場合と通さない場合で比較してみた

通した場合はクラスファイルないエラーの際、spring関連のファイル名がないことを確認できた

```
通す場合

$ java -cp "$(find $HOME/.m2/repository -type f | grep 'jar$' | xargs | tr ' ' ':'):jardump-4.2.0-SNAPSHOT-jar-with-dependencies.jar" app.App  /home/aine/.m2/repository/org/springframework/spring-webmvc/5.2.8.RELEASE/spring-webmvc-5.2.8.RELEASE.jar

通さない場合

$ java -jar jardump-4.2.0-SNAPSHOT-jar-with-dependencies.jar /home/aine/.m2/repository/org/springframework/spring-webmvc/5.2.8.RELEASE/spring-webmvc-5.2.8.RELEASE.jar
...
通した場合でも足りんクラスファイルがあるのが闇が深い

おもしろそう

```
通した場合
classLoadSkipCauseSummaryInfo	{/home/aine/.m2/repository/org/springframework/spring-webmvc/5.2.8.RELEASE/spring-webmvc-5.2.8.RELEASE.jar={java.lang.NoClassDefFoundError=[javax.servlet.jsp.jstl.fmt.LocalizationContext, org.reactivestreams.Subscriber, javax.servlet.jsp.tagext.BodyTag, javax.servlet.jsp.tagext.BodyTagSupport, javax.servlet.jsp.tagext.TryCatchFinally, javax.servlet.jsp.tagext.DynamicAttributes, org.springframework.ui.freemarker.FreeMarkerConfigurationFactory, org.apache.tiles.preparer.factory.PreparerFactory, org.apache.tiles.extras.complete.CompleteAutoloadTilesInitializer, org.apache.tiles.extras.complete.CompleteAutoloadTilesContainerFactory, org.apache.tiles.request.servlet.ServletRequest, org.apache.tiles.request.servlet.ServletApplicationContext, org.apache.tiles.locale.impl.DefaultLocaleResolver, org.apache.tiles.factory.BasicTilesContainerFactory, org.apache.tiles.startup.DefaultTilesInitializer, groovy.text.markup.TemplateConfiguration, groovy.text.markup.TemplateResolver, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function1]}}
classExecuteSkipCauseSummaryInfo	{/home/aine/.m2/repository/org/springframework/spring-webmvc/5.2.8.RELEASE/spring-webmvc-5.2.8.RELEASE.jar={java.lang.NoClassDefFoundError=[javax.servlet.jsp.PageContext, org.reactivestreams.Subscriber, javax.servlet.jsp.JspTagException, javax.servlet.jsp.JspException, freemarker.template.Configuration, freemarker.core.ParseException, com.rometools.rome.feed.WireFeed, org.apache.poi.ss.usermodel.Workbook, org.apache.tiles.request.ApplicationContext, org.apache.tiles.request.Request, org.apache.tiles.evaluator.AttributeEvaluator, org.apache.tiles.request.render.Renderer, org.apache.tiles.el.ScopeELResolver, org.springframework.oxm.Marshaller, com.fasterxml.jackson.dataformat.xml.XmlMapper, groovy.text.markup.MarkupTemplateEngine, kotlin.jvm.functions.Function1]}}

通さない場合
classLoadSkipCauseSummaryInfo	{/home/aine/.m2/repository/org/springframework/spring-webmvc/5.2.8.RELEASE/spring-webmvc-5.2.8.RELEASE.jar={java.lang.NoClassDefFoundError=[org.springframework.beans.factory.xml.NamespaceHandlerSupport, org.springframework.beans.factory.FactoryBean, org.springframework.validation.Validator, org.springframework.context.ApplicationContextAware, org.springframework.beans.factory.xml.AbstractSimpleBeanDefinitionParser, org.springframework.beans.factory.xml.BeanDefinitionParser, org.springframework.beans.factory.xml.AbstractSingleBeanDefinitionParser, org.springframework.web.context.AbstractContextLoaderInitializer, org.springframework.web.context.support.WebApplicationObjectSupport, javax.servlet.jsp.jstl.fmt.LocalizationContext, org.springframework.web.util.UriComponentsBuilder, javax.servlet.http.HttpServletResponse, org.springframework.beans.factory.InitializingBean, org.springframework.core.Ordered, javax.servlet.ServletInputStream, org.springframework.http.HttpInputMessage, org.springframework.http.server.PathContainer, org.springframework.core.io.Resource, javax.servlet.http.HttpServletResponseWrapper, org.springframework.core.ParameterizedTypeReference, org.reactivestreams.Subscriber, org.springframework.beans.MutablePropertyValues, org.springframework.context.ApplicationListener, org.springframework.ui.Model, org.springframework.context.MessageSourceAware, org.springframework.beans.factory.BeanNameAware, org.springframework.http.server.ServerHttpResponse, org.springframework.web.method.support.InvocableHandlerMethod, org.springframework.web.method.support.HandlerMethodArgumentResolver, org.springframework.web.method.support.HandlerMethodReturnValueHandler, org.springframework.beans.factory.BeanFactoryAware, org.springframework.web.method.annotation.AbstractCookieValueMethodArgumentResolver, org.springframework.web.method.annotation.AbstractNamedValueMethodArgumentResolver, org.springframework.util.concurrent.ListenableFutureCallback, org.springframework.web.method.support.UriComponentsContributor, org.springframework.web.bind.ServletRequestDataBinder, org.springframework.web.method.annotation.ModelAttributeMethodProcessor, org.springframework.web.method.HandlerMethod$HandlerMethodParameter, org.springframework.web.method.annotation.AbstractNamedValueMethodArgumentResolver$NamedValueInfo, org.springframework.web.method.annotation.InitBinderDataBinderFactory, org.springframework.context.EmbeddedValueResolverAware, org.springframework.web.method.annotation.AbstractWebArgumentResolverAdapter, org.springframework.cglib.proxy.MethodInterceptor, javax.servlet.ServletConfig, org.springframework.web.util.CookieGenerator, org.springframework.web.context.request.async.CallableProcessingInterceptor, org.springframework.context.i18n.TimeZoneAwareLocaleContext, javax.servlet.jsp.tagext.BodyTag, javax.servlet.jsp.tagext.BodyTagSupport, javax.servlet.jsp.tagext.TryCatchFinally, org.springframework.expression.PropertyAccessor, javax.servlet.jsp.tagext.DynamicAttributes, javax.servlet.ServletException, org.springframework.core.env.EnvironmentCapable, org.springframework.beans.factory.config.DestructionAwareBeanPostProcessor, javax.servlet.http.HttpServletRequestWrapper, org.springframework.web.HttpRequestHandler, org.springframework.web.context.request.ServletWebRequest, org.springframework.web.cors.CorsConfigurationSource, org.springframework.web.filter.GenericFilterBean, org.springframework.core.io.ByteArrayResource, javax.servlet.GenericServlet, org.apache.tiles.preparer.factory.PreparerFactory, org.springframework.web.context.ServletContextAware, org.apache.tiles.extras.complete.CompleteAutoloadTilesInitializer, org.apache.tiles.extras.complete.CompleteAutoloadTilesContainerFactory, org.apache.tiles.request.servlet.ServletRequest, org.apache.tiles.request.servlet.ServletApplicationContext, org.apache.tiles.locale.impl.DefaultLocaleResolver, org.apache.tiles.factory.BasicTilesContainerFactory, org.apache.tiles.startup.DefaultTilesInitializer, javax.el.CompositeELResolver, groovy.text.markup.TemplateResolver, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function1]}}
